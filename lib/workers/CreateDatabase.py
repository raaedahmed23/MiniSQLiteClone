...
class CreateDatabase:
    @staticmethod
    # defines metadata information for columns related to user tables in a database
    ...
    @staticmethod
    # defines metadata information for columns related to system tables in a database
