...
@dataclass
# Handles the creation of byte streams from instances of the class (serialization) and the reconstruction of instances from byte streams (deserialization)
class PageWriter:
    page_number: int
    ...
    # Method to convert an instance of PageWriter to a byte stream
    def object_to_bytes(self, parent_page_num: int):
        ...
        # Iterate through keys (DataCell instances)
    ...
    @classmethod
    # Class method to create an instance of PageWriter from a byte stream
    def bytes_to_object(cls, byte_stream: bytes, pg_num: int):
        ...
        # Read and store DataCell instances based on offsets
        ...
        # Create an instance of PageWriter
        return PageWriter(
            pg_num,
            header,
            list(),
